...
```text
scope   TAI5MSG_V303_PC_PAYLOAD_DEFECT_CORRECTION_2 / V304
parent  b999fea1ba121f91200efd4ac4e483cc1b3a13a0 / V303
```
...
The design must consume the V303 3,179-row release corpus plus the V304 exact two-row correction overlay. It remains design-only: no implementation, TAI5MSG output, IPS, build or hardware execution.
